...
# Language Modeling with an RNN, train language models for predicting movie review sentiment
# Code resued from run-jump-start-rnn-sentiment-v002.py (Thomas W. Miller, August 16, 2018)
# Build and evaluate four language models of the experimental design using two pre-trained word vectors and two
# vocabulary sizes
...
# The previous program, Assignment8_download_embeddings_file.ipynb
# downloaded pre-trained GloVe embeddings, saved them in a zip archive,
# and unzipped that archive to create the four word-to-embeddings (50,100,200, and 300 Dimensions)
...
#function to read the review data files
...
# GeÌron, A. 2017. Hands-On Machine Learning with Scikit-Learn & TensorFlow: 
